...
1. Download `gpt-to-obsidian-saver-v1.5.40-unpacked-extension.zip` from the GitHub Release.
2. Download `SHA256SUMS.txt`.
3. Verify the checksum:

```sh
shasum -a 256 gpt-to-obsidian-saver-v1.5.40-unpacked-extension.zip
```
...
9. Confirm the displayed version is `1.5.40`.
