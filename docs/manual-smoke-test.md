...
This file preserves the v1.5.40 release procedure. Create a version-specific checklist for each newer release and do not report this historical checklist as current live evidence.
