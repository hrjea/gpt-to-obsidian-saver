...
1. GitHub Release에서 `gpt-to-obsidian-saver-v1.5.40-unpacked-extension.zip`을 다운로드합니다.
...
2. `gpt-to-obsidian-saver-v1.5.40-native-host-macos.zip`을 다운로드하고 압축 해제합니다.
3. 다음을 실행합니다.
